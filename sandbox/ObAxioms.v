...
Notation "x * y" := (AP x y) : Ob_scope.

Open Scope Ob_scope.
Delimit Scope Ob_scope with Ob.
Bind Scope Ob_scope with Ob.

Notation "x 'o' y" := (B * x * y) : Ob_scope.
Notation "x || y" := (J * x * y) : Ob_scope.
Notation "x (+) y" := (R * x * y) : Ob_scope.
Notation "x [= y" := (LESS x y) : Ob_scope.
Notation "x [!= y" := (NLESS x y) : Ob_scope.
